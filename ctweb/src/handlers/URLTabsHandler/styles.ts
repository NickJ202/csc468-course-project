...
export const Tab = styled.li<IStyleProps>`
  ...
  color: ${props => props.active ?
    props.theme.colors.font.secondary : props.theme.colors.font.active};
  border-bottom: 2px solid ${props => props.active ? 
          props.theme.colors.tab.active.border : props.theme.colors.transparent};
  cursor: pointer;
  padding: 10.5px 15px 9.5px 15px;
  background: ${props => props.active ?
    props.theme.colors.tab.active.background : props.theme.colors.transparent};
