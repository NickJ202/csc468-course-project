...
export default function EventCreateBasicInfo() {
    ...
    const eventCreateData = useSelector((state: RootState) => state.eventCreateReducer);
    const [title, setTitle] = React.useState<string>(eventCreateData.title || "");
    const [description, setDescription] = React.useState<string>(eventCreateData.description || "");
