...
import {checkCurrentPath, checkDesktop, checkWindowResize, hideDocumentBody, formatCapitalize} from "../util";
    ...
    return (
        <S.NavigationLink active={active} href={props.href}>
            <S.RowContainer>
                ...
                {!props.desktop &&
                <S.Name>
                    {props.name.charAt(0).toUpperCase() + props.name.substring(1, props.name.length)}
                </S.Name>
                }
            </S.RowContainer>
        </S.NavigationLink>
...
export default function Navigation() {
    ...
    return (
        <nav>
            ...
            <>
                {!desktop &&
                <S.Backdrop onClick={handleNavStatus}/>
                }
                <NavigationContainer>
                    <a href={U.base}>
                        <S.LogoContainer>
